...
export default function AdminReports() {
  ...
  const handleExportPDF = () => {
    try {
      ...
      // Tabla
      pdf.setFontSize(13);
      pdf.text("Recent Activity", 14, 98);
      ...
      if (history.length === 0) {
        pdf.text("No activity found for this period.", 18, y + 10);
      } else {
        pdf.setFontSize(10);
        ...
        history.forEach((item, index) => {
          ...
          if (item.event === "Purchase" && item.amount) {
            ...
            const normalized = cleanValue > 999 ? cleanValue / 100 : cleanValue;
      ...
      pdf.save(
        `DisasterMatch_Report_${filterMode}_${now.getFullYear()}_${
          now.getMonth() + 1
        }.pdf`
      );
